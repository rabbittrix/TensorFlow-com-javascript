...
*/
console.log(`0 XOR 0 = ${parseFloat(predict([0, 0], 'dados04')).toFixed(0)}`);
console.log(`0 XOR 1 = ${parseFloat(predict([0, 1], 'dados04')).toFixed(0)}`);
console.log(`1 XOR 0 = ${parseFloat(predict([1, 0], 'dados04')).toFixed(0)}`);
console.log(`1 XOR 1 = ${parseFloat(predict([1, 1], 'dados04')).toFixed(0)}`);
