...
console.log(`0 XOR 0 = ${parseFloat(net.predict([0, 0])).toFixed(0)}`);
console.log(`0 XOR 1 = ${parseFloat(net.predict([0, 1])).toFixed(0)}`);
console.log(`1 XOR 0 = ${parseFloat(net.predict([1, 0])).toFixed(0)}`);
console.log(`1 XOR 1 = ${parseFloat(net.predict([1, 1])).toFixed(0)}`);
